...
export default function Header() {
    ...
    return(
        ...
        <div className="w-full max-[640px]:w-1/2 flex justify-end max-[640px]:justify-center items-center">
        <ul className="flex flex-row items-center gap-5 p-2.5 whitespace-nowrap justify-center">
            ...
            <li><Link target="_blank" href="https://github.com/thuxgn"><Image width={30} height={30} className="transition-transform duration-300 ease-out hover:scale-120" src="/GitHub_Invertocat_Black.png" alt="Github" /></Link></li>
            <li><Link target="_blank" href="https://www.instagram.com/thuxgn/"><Image width={30} height={30} className="transition-transform duration-300 ease-out hover:scale-120" src="/ig.png" alt="Instagram" /></Link></li>
