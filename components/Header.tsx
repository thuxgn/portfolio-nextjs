...
export default function Header() {
    ...
    return(
        ...
        <div className="relative w-[260px] h-[90px] min-[620px]:w-[240px] min-[620px]:h-[80px] max-[620px]:w-[200px] max-[620px]:h-[70px]">
            <Image className="object-cover" fill priority src="/thuxgn1000px.png" alt="logo" />
        </div>
        ...
        <ul className="flex flex-row items-center gap-5 p-2.5 whitespace-nowrap justify-center">
            ...
            <li><Link target="_blank" href="mailto:thuxgn.business@gmail.com"><Image width={30} height={30} className="transition-transform duration-300 ease-out hover:scale-120" src="/email.png" alt="Email" /></Link></li>
            <li><Link target="_blank" href="https://www.youtube.com/@thuxgn"><Image width={30} height={30} className="transition-transform duration-300 ease-out hover:scale-120" src="/youtube.png" alt="YouTube" /></Link></li>
